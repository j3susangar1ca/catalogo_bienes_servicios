...
// ==========================================
// Main: Ejecución y Benchmarking
// ==========================================
fn main() {
    let mut catalog = index::CatalogIndex::new(64_000);

    // Simulando inserciones (Pre-computación e Indexación)
    catalog.insert(1, "Bomba centrífuga de agua");
    catalog.insert(2, "Bomba centifuga"); // Error tipográfico
    ...
    let query = "Válvula";
    let threshold = 0.1; // Umbral intencionalmente bajo para ver el match asimétrico
